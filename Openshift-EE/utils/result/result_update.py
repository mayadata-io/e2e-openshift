...
path = 'Openshift-EE/pipelines/ElasticSearch/stages/{}'.format(stage)
job_folder = "" 
...
updated_path = "Openshift-EE/pipelines/ElasticSearch/stages/{}/{}/README.md".format(stage,job_folder)
