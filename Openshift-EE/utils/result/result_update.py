...
default_path = 'Openshift-EE/pipelines/mongodb/stages/{}'.format(stage)
job_dir = ""
...
job_dir_path = "Openshift-EE/pipelines/mongodb/stages/{}/{}".format(stage,job_dir)
...
# readme.md file path
file_path = "Openshift-EE/pipelines/mongodb/stages/{}/{}/README.md".format(stage, job_dir)
print(file_path)
