### Verify applicaton availablity when node is freezed due to cpu-pressure.\r
\r
#### Description\r
Induce node freeze due to cpu pressure and check if application is rescheduled and verify its availability.\r
\r
#### Prerequisites\r
