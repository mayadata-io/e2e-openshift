...
default_path = 'openebs-openshift-e2e/pipelines/cstor-csi/stages/{}'.format(stage)
job_dir = ""
...
job_dir_path = "openebs-openshift-e2e/pipelines/cstor-csi/stages/{}/{}".format(stage, job_dir)
...
# readme.md file path
file_path = "openebs-openshift-e2e/pipelines/cstor-csi/stages/{}/{}/README.md".format(stage, job_dir)
print(file_path)
